...
def _safe_query(
    source_name: str, doc_type: DocumentType = DocumentType.CUSTOM, doc_number: str = "", **extra
):
...
def test_ar_dnrpa_query_plate():
    ...
    print(
        f"\nDNRPA AB123CD: registro={result.registro_seccional!r}, provincia={result.provincia!r}"
    )
