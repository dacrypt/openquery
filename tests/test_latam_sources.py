...
class TestPeOsceSancionados:
    ...
    def test_model_roundtrip(self):
        ...
        p = ProveedorSancionado(
            nombre="CONSTRUCTORA X", ruc="20999888777", sancion="INHABILITACION"
        )
...
class TestPeServirSanciones:
    ...
    def test_model_roundtrip(self):
        ...
        s = SancionServidor(
            nombre="GARCIA LOPEZ PEDRO", entidad="MINSA", tipo_sancion="DESTITUCION"
        )
...
class TestMxSatEfos:
    ...
    def test_model_roundtrip(self):
        ...
        c = ContribuyenteEfos(
            rfc="ABC123456XYZ", nombre="EMPRESA FANTASMA SA", situacion="Definitivo"
        )
...
class TestArAfipCuit:
    ...
    def test_model_roundtrip(self):
        ...
        r = AfipCuitResult(
            cuit="20-12345678-9", razon_social="EMPRESA ARGENTINA SRL", estado="ACTIVO"
        )
...
class TestArDnrpa:
    ...
    def test_model_roundtrip(self):
        ...
        r = DnrpaResult(
            dominio="AB123CD", registro_seccional="Seccional 1 CABA", provincia="BUENOS AIRES"
        )
