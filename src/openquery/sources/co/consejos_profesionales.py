...
CONSEJOS = [
    {
        ...
        "description": "Consejo Profesional Nacional de Tecnólogos en Electricidad, Electromecánica, Electrónica y afines",  # noqa: E501
    ...
    },
    {
        ...
        "description": "Consejo Profesional de Ingeniería Mecánica, Electrónica y profesiones afines",  # noqa: E501
    ...
    },
    {
        ...
        "description": "Consejo Profesional Nacional de Arquitectura y sus Profesiones Auxiliares (CPNAA)",  # noqa: E501
    ...
    },
    {
        ...
        "description": "Consejo Profesional de Medicina Veterinaria y Zootecnia de Colombia (COMVEZCOL)",  # noqa: E501
...
def _make_consejo_source(config: dict) -> type[BaseSource]:
    ...
    class ConsejoSource(BaseSource):
        ...
        def _parse_result(
            self, page, documento: str, doc_type: DocumentType
        ) -> ConsejoProfesionalResult:
            ...
            if no_registrado:
                ...
                result.mensaje = (
                    f"Matrícula {result.estado_matricula or 'registrada'} en {consejo_label}"
                )
