...
SOURCE_URL = "https://www.vehiculosvalle.com.co/impuestosweb"
...
class ImpuestoVehicularValleSource(ImpuestoVehicularBaseSource):
    ...
    Quipux AngularJS SPA at vehiculosvalle.com.co/impuestosweb.
    The consulta-general form uses hCaptcha protection.
    Input selectors after Angular renders: input[name='placa'] or input[id='placa']
    with a submit button type='submit' or ng-click for consulta.
    """
    ...
    def _query(
        ...
        with browser.page(self._source_url, wait_until="domcontentloaded") as page:
            try:
                ...
                # Quipux Innova AngularJS SPA — the consulta-general feature is enabled
                # ($MostrarConsultaGeneral = true). Navigate to the public consulta route.
                ...
                # Wait for the consulta-general form to render with a placa input
                placa_sel = (
